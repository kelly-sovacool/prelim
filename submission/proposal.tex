...
Taxonomic composition is often compared between communities by calculating beta diversity and plotting an ordination to visualize separation between disease states.
However, patient stool samples cannot be classified as having SRNs or not using Bray-Curtis dissimilarity as the beta diversity metric,
...
This finding has been observed not only across independent CRC datasets but also in other diseases including obesity, oral cancer \cite{weir_stool_2013, finucane_taxonomic_2014, perrera_inflammatory_2018}.

Thus, there is a point of tension; complex changes in gut microbiome composition are implicated in disease,
but interpersonal variability obscures easily-recognizable patterns that could be used to distinguish disease states.
