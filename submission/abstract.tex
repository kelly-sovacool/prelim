...
Sequencing whole metagenomes allows one to identify genes present and annotate known gene functions to build a profile of functional potential of the microbiome.
Combining taxonomic composition from 16S sequences with functional potential from metagenomes allows one to characterize functional redundancy across communities, where communities with similar functional potential have different taxonomic composition.
Untargeted mass spectrometry can further validate the functional potential from metagenomics by identifying metabolites that are active in a community.
